...
string chop_string(const char *s, int width, bool spaces = true, bool left_justify = true);
string chop_string(const string &s, int width, bool spaces = true, bool left_justify = true);
