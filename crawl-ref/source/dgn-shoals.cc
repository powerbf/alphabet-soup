...
static const char *PROPS_SHOALS_TIDE_KEY = "shoals-tide-height"; // noextract
static const char *PROPS_SHOALS_TIDE_VEL = "shoals-tide-velocity"; // noextract
static const char *PROPS_SHOALS_TIDE_UPDATE_TIME = "shoals-tide-update-time"; // noextract
...
void dgn_build_shoals_level()
{
    ...
    env.level_build_method += make_stringf(" [depth %d]", you.depth); // noextract
