    ...
    if (reconvert) // Maybe all of them are invisible.
    {
        ...
        if (num_reconvert > 0)
        {
            if (num_reconvert == 1 && num_followers > 1)
                chan << localize("One of your followers decides to abandon you.");
            else if (num_reconvert == num_followers)
                chan << localize("Your followers decide to abandon you.");
            else
                chan << localize("Some of your followers decide to abandon you.");
        }
