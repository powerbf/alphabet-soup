...
string chop_string(const char *s, int width, bool spaces, bool left_justify)
{
    const char *s0 = s;
    char32_t c;
...
string chop_string(const string &s, int width, bool spaces, bool left_justify)
{
    return chop_string(s.c_str(), width, spaces, left_justify);
}
